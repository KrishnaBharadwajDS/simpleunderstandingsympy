...
def matrixoperations():
    ...
    inverse_matrix = matrix1 ** -1
    print(f"The inverse of the Matrix1 is {inverse_matrix}\n")

    determinant_matrix = matrix1.det()
    print(f"The determinant of Matrix1 is {determinant_matrix}\n")

    matrix2 = Matrix([[5, 6], [8, 9], [1, 2]])
